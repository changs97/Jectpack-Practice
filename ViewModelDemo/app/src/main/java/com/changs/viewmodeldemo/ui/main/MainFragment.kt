...
import com.changs.viewmodeldemo.BR.myViewModel
...
class MainFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.main_fragment, container, false)//데이터 바인딩
        binding.setLifecycleOwner(this) //프래그먼트가 소멸될 때 바인딩 객체도 소멸되도록 바인딩 객체의 생명주기 소유자를 설정정
       return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        * resultObserver의 onChanged() 콜백 함수가 실행되어 resultText의 값이 변경된다.*/
        ...
        //viewModel.getResult().observe(viewLifecycleOwner, resultObserver) 데이터 바인딩 적용으로 주석 처리
